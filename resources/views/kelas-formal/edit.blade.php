...
@section('title', 'Edit Kelas Formal - SIKEU MHI V2')

@section('page_title', 'Edit Kelas Formal')

@section('page_subtitle', 'Perbarui data kelas formal dan nominal SPP.')
...
@section('content')
    ...
    <form action="{{ route('kelas-formal.update', $kelas->id_kelas) }}" method="POST">
        @csrf
        @method('PUT')

        <div class="card">
            <h3 class="section-title">Form Edit Kelas Formal</h3>
